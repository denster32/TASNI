...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.18717105.svg)](https://doi.org/10.5281/zenodo.18717105)

**Version:** 1.0.0 (Released 2026-02-23)
**Status:** Publication Ready
**DOI:** [10.5281/zenodo.18717105](https://doi.org/10.5281/zenodo.18717105)

---

## Project Overview

TASNI identifies "fading thermal orphans"---sources detectable only in the mid-infrared (WISE W1/W2) that systematically dim over a decade. From **747,634,026** WISE sources, we discovered **3 confirmed candidates** with cold temperatures comparable to known Y dwarfs (251--293 K), high proper motions (55--306 mas/yr), and monotonic fading (17--53 mmag/yr), plus one additional LMC member. The NEOWISE mission was decommissioned in August 2024, making this the final baseline for such a search.
